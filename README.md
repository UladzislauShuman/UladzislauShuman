...
Java backend developer with experience building microservice applications. Participated in the monolith splitting process, designed and implemented REST APIs for services, developed comprehensive security models, and integrated third-party APIs (Stripe, SendGrid).
...
| ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 🚑 **[Emergency User Service (Microservices)](https://github.com/UladzislauShuman/emergency-user-service)** | A microservice-based platform connecting users with nearby paramedics. Features **permission-based security** (JWT, OAuth2), multi-step **KYC verification** with document uploads to **Azure Blob Storage**, subscription management via **Stripe** with webhook processing, and asynchronous notifications through **RabbitMQ** and **SendGrid**. Fully containerized with **Docker**. | `Spring Cloud` `Spring Security` `RabbitMQ` `Stripe API` `OpenFeign` `Azure Blob` `Redis` `PostgreSQL`                                                                                                                     |
...
![Jira](https://img.shields.io/badge/jira-%230A82FF.svg?style=for-the-badge&logo=jira&logoColor=white)
